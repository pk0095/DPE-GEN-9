...
//Gen 9
#define SPECIES_SPRIGATITO 0x4EC
#define SPECIES_FLORAGATO 0x4ED
#define SPECIES_MEOWSCARADA 0x4EE
#define SPECIES_FUECOCO 0x4EF
#define SPECIES_CROCALOR 0x4F0
#define SPECIES_SKELEDIRGE 0x4F1
#define SPECIES_QUAXLY 0x4F2
#define SPECIES_QUAXWELL 0x4F3
#define SPECIES_QUAQUAVAL 0x4F4
#define SPECIES_LECHONK 0x4F5
#define SPECIES_OINKOLOGNE 0x4F6
#define SPECIES_OINKOLOGNE_FEMALE 0x4F7
#define SPECIES_TAROUNTULA 0x4F8
#define SPECIES_SPIDOPS 0x4F9
#define SPECIES_NYMBLE 0x4FA
#define SPECIES_LOKIX 0x4FB
#define SPECIES_PAWMI 0x4FC
#define SPECIES_PAWMO 0x4FD
#define SPECIES_PAWMOT 0x4FE
#define SPECIES_TANDEMAUS 0x4FF
#define SPECIES_MAUSHOLD 0x500
#define SPECIES_MAUSHOLD_FOUR 0x501
#define SPECIES_FIDOUGH 0x502
#define SPECIES_DACHSBUN 0x503
#define SPECIES_SMOLIV 0x504
#define SPECIES_DOLLIV 0x505
#define SPECIES_ARBOLIVA 0x506
#define SPECIES_SQUAWKABILLY 0x507
#define SPECIES_SQUAWKABILLY_BLUE 0x508
#define SPECIES_SQUAWKABILLY_YELLOW 0x509
#define SPECIES_SQUAWKABILLY_WHITE 0x50A
#define SPECIES_NACLI 0x50B
#define SPECIES_NACLSTACK 0x50C
#define SPECIES_GARGANACL 0x50D
#define SPECIES_CHARCADET 0x50E
#define SPECIES_ARMAROUGE 0x50F
#define SPECIES_CERULEDGE 0x510
#define SPECIES_TADBULB 0x511
#define SPECIES_BELLIBOLT 0x512
#define SPECIES_WATTREL 0x513
#define SPECIES_KILOWATTREL 0x514
#define SPECIES_MASCHIFF 0x515
#define SPECIES_MABOSSTIFF 0x516
#define SPECIES_SHROODLE 0x517
#define SPECIES_GRAFAIAI 0x518
#define SPECIES_BRAMBLIN 0x519
#define SPECIES_BRAMBLEGHAST 0x51A
#define SPECIES_TOEDSCOOL 0x51B
#define SPECIES_TOEDSCRUEL 0x51C
#define SPECIES_KLAWF 0x51D
#define SPECIES_CAPSAKID 0x51E
#define SPECIES_SCOVILLAIN 0x51F
#define SPECIES_RELLOR 0x520
#define SPECIES_RABSCA 0x521
#define SPECIES_FLITTLE 0x522
#define SPECIES_ESPATHRA 0x523
#define SPECIES_TINKATINK 0x524
#define SPECIES_TINKATUFF 0x525
#define SPECIES_TINKATON 0x526
#define SPECIES_WIGLETT 0x527
#define SPECIES_WUGTRIO 0x528
#define SPECIES_BOMBIRDIER 0x529
#define SPECIES_FINIZEN 0x52A
#define SPECIES_PALAFIN 0x52B
#define SPECIES_PALAFIN_HERO 0x52C
#define SPECIES_VAROOM 0x52D
#define SPECIES_REVAVROOM 0x52E
#define SPECIES_CYCLIZAR 0x52F
#define SPECIES_ORTHWORM 0x530
#define SPECIES_GLIMMET 0x531
#define SPECIES_GLIMMORA 0x532
#define SPECIES_GREAVARD 0x533
#define SPECIES_HOUNDSTONE 0x534
#define SPECIES_FLAMIGO 0x535
#define SPECIES_CETODDLE 0x536
#define SPECIES_CETITAN 0x537
#define SPECIES_VELUZA 0x538
#define SPECIES_DONDOZO 0x539
#define SPECIES_TATSUGIRI 0x53A
#define SPECIES_TATSUGIRI_RED 0x53B
#define SPECIES_TATSUGIRI_YELLOW 0x53C
#define SPECIES_ANNIHILAPE 0x53D
#define SPECIES_CLODSIRE 0x53E
#define SPECIES_FARIGIRAF 0x53F
#define SPECIES_DUDUNSPARCE 0x540
#define SPECIES_DUDUNSPARCE_THREE 0x541
#define SPECIES_KINGAMBIT 0x542
#define SPECIES_GREAT_TUSK 0x543
#define SPECIES_SCREAM_TAIL 0x544
#define SPECIES_BRUTE_BONNET 0x545
#define SPECIES_FLUTTER_MANE 0x546
#define SPECIES_SLITHER_WING 0x547
#define SPECIES_SANDY_SHOCKS 0x548
#define SPECIES_IRON_TREADS 0x549
#define SPECIES_IRON_BUNDLE 0x54A
#define SPECIES_IRON_HANDS 0x54B
#define SPECIES_IRON_JUGULIS 0x54C
#define SPECIES_IRON_MOTH 0x54D
#define SPECIES_IRON_THORNS 0x54E
#define SPECIES_FRIGIBAX 0x54F
#define SPECIES_ARCTIBAX 0x550
#define SPECIES_BAXCALIBUR 0x551
#define SPECIES_GIMMIGHOUL 0x552
#define SPECIES_GIMMIGHOUL_ROAMING 0x553
#define SPECIES_GHOLDENGO 0x554
#define SPECIES_WO_CHIEN 0x555
#define SPECIES_CHIEN_PAO 0x556
#define SPECIES_TING_LU 0x557
#define SPECIES_CHI_YU 0x558
#define SPECIES_ROARING_MOON 0x559
#define SPECIES_IRON_VALIANT 0x55A
#define SPECIES_KORAIDON 0x55B
#define SPECIES_MIRAIDON 0x55C
#define SPECIES_WALKING_WAKE 0x55D
#define SPECIES_IRON_LEAVES 0x55E
#define SPECIES_TAUROS_P 0x55F
#define SPECIES_TAUROS_BLAZE_P 0x560
#define SPECIES_TAUROS_AQUA_P 0x561
#define SPECIES_WOOPER_P 0x562
#define SPECIES_URSALUNA_BLOODMOON 0x563
#define SPECIES_DIPPLIN 0x564
#define SPECIES_POLTCHAGEIST 0x565
#define SPECIES_POLTCHAGEIST_ARTISAN 0x566
#define SPECIES_SINISTCHA 0x567
#define SPECIES_SINISTCHA_MASTERPIECE 0x568
#define SPECIES_OKIDOGI 0x569
#define SPECIES_MUNKIDORI 0x56A
#define SPECIES_FEZANDIPITI 0x56B
#define SPECIES_OGERPON 0x56C
#define SPECIES_OGERPON_WELLSPRING_MASK 0x56D
#define SPECIES_OGERPON_HEARTHFLAME_MASK 0x56E
#define SPECIES_OGERPON_CORNERSTONE_MASK 0x56F
#define SPECIES_ARCHALUDON 0x570
#define SPECIES_HYDRAPPLE 0x571
#define SPECIES_GOUGING_FIRE 0x572
#define SPECIES_RAGING_BOLT 0x573
#define SPECIES_IRON_BOULDER 0x574
#define SPECIES_IRON_CROWN 0x575
#define SPECIES_TERAPAGOS 0x576
#define SPECIES_TERAPAGOS_TERASTAL 0x577
#define SPECIES_TERAPAGOS_STELLAR 0x578
#define SPECIES_PECHARUNT 0x579

//G-Max
#define SPECIES_VENUSAUR_GIGA (LAST_NORMAL_SPECIES + 1)
#define SPECIES_CHARIZARD_GIGA (LAST_NORMAL_SPECIES + 2)
#define SPECIES_BLASTOISE_GIGA (LAST_NORMAL_SPECIES + 3)
#define SPECIES_BUTTERFREE_GIGA (LAST_NORMAL_SPECIES + 4)
#define SPECIES_PIKACHU_GIGA (LAST_NORMAL_SPECIES + 5)
#define SPECIES_MEOWTH_GIGA (LAST_NORMAL_SPECIES + 6)
#define SPECIES_MACHAMP_GIGA (LAST_NORMAL_SPECIES + 7)
#define SPECIES_GENGAR_GIGA (LAST_NORMAL_SPECIES + 8)
#define SPECIES_KINGLER_GIGA (LAST_NORMAL_SPECIES + 9)
#define SPECIES_LAPRAS_GIGA (LAST_NORMAL_SPECIES + 10)
#define SPECIES_EEVEE_GIGA (LAST_NORMAL_SPECIES + 11)
#define SPECIES_SNORLAX_GIGA (LAST_NORMAL_SPECIES + 12)
#define SPECIES_GARBODOR_GIGA (LAST_NORMAL_SPECIES + 13)
#define SPECIES_MELMETAL_GIGA (LAST_NORMAL_SPECIES + 14)
#define SPECIES_RILLABOOM_GIGA (LAST_NORMAL_SPECIES + 15)
#define SPECIES_CINDERACE_GIGA (LAST_NORMAL_SPECIES + 16)
#define SPECIES_INTELEON_GIGA (LAST_NORMAL_SPECIES + 17)
#define SPECIES_CORVIKNIGHT_GIGA (LAST_NORMAL_SPECIES + 18)
#define SPECIES_ORBEETLE_GIGA (LAST_NORMAL_SPECIES + 19)
#define SPECIES_DREDNAW_GIGA (LAST_NORMAL_SPECIES + 20)
#define SPECIES_COALOSSAL_GIGA (LAST_NORMAL_SPECIES + 21)
#define SPECIES_FLAPPLE_GIGA (LAST_NORMAL_SPECIES + 22)
#define SPECIES_APPLETUN_GIGA (LAST_NORMAL_SPECIES + 23)
#define SPECIES_SANDACONDA_GIGA (LAST_NORMAL_SPECIES + 24)
#define SPECIES_TOXTRICITY_GIGA (LAST_NORMAL_SPECIES + 25)
#define SPECIES_TOXTRICITY_LOW_KEY_GIGA (LAST_NORMAL_SPECIES + 26)
#define SPECIES_CENTISKORCH_GIGA (LAST_NORMAL_SPECIES + 27)
#define SPECIES_HATTERENE_GIGA (LAST_NORMAL_SPECIES + 28)
#define SPECIES_GRIMMSNARL_GIGA (LAST_NORMAL_SPECIES + 29)
#define SPECIES_ALCREMIE_GIGA (LAST_NORMAL_SPECIES + 30)
#define SPECIES_COPPERAJAH_GIGA (LAST_NORMAL_SPECIES + 31)
#define SPECIES_DURALUDON_GIGA (LAST_NORMAL_SPECIES + 32)
#define SPECIES_URSHIFU_SINGLE_GIGA (LAST_NORMAL_SPECIES + 33)
#define SPECIES_URSHIFU_RAPID_GIGA (LAST_NORMAL_SPECIES + 34)

#define LAST_NORMAL_SPECIES SPECIES_PECHARUNT
#define NUM_SPECIES (SPECIES_URSHIFU_RAPID_GIGA + 1) //1436
